                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="filter-start-date" type="text" placeholder="dd/MM/yyyy" name="filter-start-date" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="filter-end-date">End date*:</label>
                                        <input class="form-control" id="filter-end-date" type="text" placeholder="dd/MM/yyyy" name="filter-end-date" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group text-center">
                                        <button name="rooms-search" id="rooms-search" class="btn btn-info"><i class="las la-search mr-2"></i>Search</button>
                                    </div>
                                </div>
